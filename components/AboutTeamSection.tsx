        ...
        >
          {extendedTeam.map((member, index) => (
            ...
            >
              ...
              <button 
                onClick={() => setSelectedMember(member)}
                className="absolute bottom-10 -right-5  bg-primary hover:bg-primary-hover text-white font-semibold text-[14px] px-6 py-3 transition-all duration-300 shadow-xl z-20 flex items-center gap-1 group-hover:pr-4"
              >
