      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 pt-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
          ...
          <div className="flex items-center space-x-3">
            <a href="https://www.facebook.com/share/1Bx4uYhnRu/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#0f172a] hover:bg-primary transition-colors flex items-center justify-center rounded-sm text-white" aria-label="Facebook">
              <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
              </svg>
            </a>
            <a href="https://www.linkedin.com/company/bingodee-company-limited/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#0f172a] hover:bg-primary transition-colors flex items-center justify-center rounded-sm text-white" aria-label="LinkedIn">
              <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
              </svg>
            </a>
            <a href="#" className="w-10 h-10 bg-[#0f172a] hover:bg-primary transition-colors flex items-center justify-center rounded-sm text-white" aria-label="Instagram">
              <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://wa.me/233244919613" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#0f172a] hover:bg-primary transition-colors flex items-center justify-center rounded-sm text-white" aria-label="WhatsApp">
              <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex gap-16 md:gap-32">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href="/" className="text-[15px] text-gray-600 hover:text-primary transition-colors">Home</Link></li>
                <li><Link href="/about" className="text-[15px] text-gray-600 hover:text-primary transition-colors">About Us</Link></li>
                <li><Link href="/products" className="text-[15px] text-gray-600 hover:text-primary transition-colors">Products</Link></li>
                <li><Link href="/services" className="text-[15px] text-gray-600 hover:text-primary transition-colors">Services</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href="/about#story" className="text-[15px] text-gray-600 hover:text-primary transition-colors">Our Story</Link></li>
                <li><Link href="/about#team" className="text-[15px] text-gray-600 hover:text-primary transition-colors">Our Team</Link></li>
              </ul>
            </div>
          </div>
